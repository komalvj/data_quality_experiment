...
def evaluate_models(X, y, model_name, proportion, scenario, cv_folds=5):
    ...
    # Assume 'person_home_ownership' is at index 2, 'loan_intent' at index 4, etc.
    categorical_indices = [2, 4, 5, 9]  # Replace with your categorical column indices
...
def plot_results(results):
    ...
    # plt.title('Impact of Inconsistently represented data on Regression Models')
